...
-- Schema NBG
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `NBG` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
-- -----------------------------------------------------
-- Schema nbgardens
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `NBG`.`permission`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `NBG`.`permission` (
  `foriegn key stuff` INT NOT NULL COMMENT '',
  PRIMARY KEY (`foriegn key stuff`)  COMMENT '')
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `NBG`.`staffRoleLink`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `NBG`.`staffRoleLink` (
  `foregienkeystuff` INT NOT NULL COMMENT '',
  PRIMARY KEY (`foregienkeystuff`)  COMMENT '')
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `NBG`.`orderStatus`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `NBG`.`orderStatus` (
...
CREATE TABLE IF NOT EXISTS `nbgardens`.`orderEvent` (
  `orderEventID` INT NOT NULL AUTO_INCREMENT COMMENT '',
