INSERT INTO `nbgardens`.`customer` (`firstName`, `lastName`, `DOB`, `email`, `creditRemaining`, `phoneNumber`, `dateCreated`, `dateModified`, `customerstatus_statusId`, `Address_addressId`, `username`, `password`)
VALUES 
